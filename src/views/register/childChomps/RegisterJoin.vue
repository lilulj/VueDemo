  ...
  <login-and-register>
    <div slot="login-item-left">
      ...
      <div class="login-left-middle displayflex">
        ...
        <div>
          <h3>招聘效果好</h3>
          <p class="login-fontSize-one">与职场牛人在线开聊</p>
        </div>
      </div>
      <div class="login-left-middle displayflex">
        ...
        <div>
          <h3>更过在线牛人</h3>
          <p class="login-fontSize-one">入职速度快</p>
        </div>
      </div>
      <div class="login-left-middle displayflex">
        <p class="icon icon-three"></p>
        <div>
          <h3>人才匹配度高</h3>
          <p class="login-fontSize-one">获取更精准的牛人</p>
        </div>
      </div>
    </div>
    ...
    <el-form :model="formData" :rules="rules" ref="formData" slot="middle">
      ...
      <el-form-item prop="message" class="message">
        ...
        <el-button class="entermessage" @getCode="getCode">发送验证码</el-button>
      </el-form-item>
      <el-form-item>
      ...
      <el-form-item class="login-fast" prop="type">
        <el-checkbox-group v-model="formData.type">
          <el-checkbox label="我已同意用户协议及隐私政策" name="type"></el-checkbox>
        </el-checkbox-group>
